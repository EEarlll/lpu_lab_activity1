            ...
            <div class="my-5 mx-5">
                ...
                <div class="">
                    <div class="col">
                        ...
                        <div class="row row-cols-2 gx-5 overflow-hidden">
                            <div class="col">
                                <div class="bg-white rounded mt-5 h-100">
                                    <div class="mt-4 p-4">
                                        <h5 class="text-center">Number of Privilege Users</h5>
                                        <h5 class="text-center"><?php echo $result3[3][0] ?></h5>
                                        <canvas id="chart2" height="100" class="mt-5"></canvas>
                                    </div>
                                </div>
                            </div>
                            <div class="col">
                                <div class="bg-white rounded p-4 mt-5 h-100">
                                    <div>
